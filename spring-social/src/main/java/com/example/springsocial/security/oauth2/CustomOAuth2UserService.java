...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private OAuth2User processOAuth2User(OAuth2UserRequest oAuth2UserRequest, OAuth2User oAuth2User) {
        ...
        if (userOptional.isPresent()) {
            ...
            AuthProvider provider = getProvider(oAuth2UserRequest.getClientRegistration().getRegistrationId());
    ...
    private AuthProvider getProvider(String providerId) {
        return AuthProvider.valueOf(providerId.toUpperCase());
    }
